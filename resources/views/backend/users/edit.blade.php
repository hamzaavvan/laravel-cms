				...
				<fieldset>
						...
						<div class="col-lg-10">
							<select class="form-control" id="role" name="role[]" multiple>
								@foreach($roles as $role)
									<option value="{!! $role->name !!}" {{in_array($role->name, $selectedRole) ? 'selected="selected"' : ''}}>
										{!! $role->name !!}
									</option>
								@endforeach
							</select>
					...
					<div class="form-group">
						<div class="col-lg-10 col-lg-offset-2">
							<a href="{!! action('Admin\UserController@index') !!}" type="reset" class="btn btn-default">Cancel</a>
